...
// Validate ../../app/(dashboard)/integrations/[id]/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/integrations/[id]">> = Specific
  const handler = {} as typeof import("../../app/(dashboard)/integrations/[id]/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../app/(dashboard)/integrations/callback/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/integrations/callback">> = Specific
  const handler = {} as typeof import("../../app/(dashboard)/integrations/callback/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
